...
export function AgentTable({ agents }: AgentTableProps) {
  ...
  const SortableHead = ({
    ...
    <TableHead
      className={cn(
        "cursor-pointer select-none hover:text-green-400 transition-colors text-zinc-400",
        className
      )}
      ...
      <Table>
        <TableHeader>
          <TableRow className="border-zinc-800 hover:bg-zinc-900/50">
            <SortableHead field="rank" className="w-[60px]">
              #
            </SortableHead>
            ...
            <SortableHead field="marketCap" className="hidden sm:table-cell">
              MCap
            </SortableHead>
            <SortableHead field="price" className="hidden lg:table-cell">
              Price
            </SortableHead>
            <SortableHead field="priceChange24h">24h %</SortableHead>
            <SortableHead field="volume24h" className="hidden md:table-cell">
              Volume
            </SortableHead>
            <SortableHead field="holderCount" className="hidden lg:table-cell">
              Holders
            </SortableHead>
          </TableRow>
        </TableHeader>
        <TableBody>
          {sorted.map((agent) => {
            ...
            return (
              <TableRow
                key={agent.address}
                className="border-zinc-800 hover:bg-zinc-900/70 cursor-pointer transition-colors"
              >
